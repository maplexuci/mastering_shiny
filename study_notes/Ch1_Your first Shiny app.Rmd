...
In traditional R scripting, we use two techniques to deal with duplicated code: either we **capture the value using a variable**, or **capture the computation with a function**. Unfortunately **neither of these approaches work here**, reasons will be explaied in the end of the chapter. So we need a new mechanism: **reactive expressions**.
